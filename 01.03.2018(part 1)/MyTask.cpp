...
void main()
{
	...
	while (true)
	{
		...
		else if (nz == 1)
		{
			...
			system("cls");
			char first[Size];
			printf("1. Составить программу, которая \na.запрашивает имя человека и повторяет его на экране;\nb.запрашивает имя человека и повторяет его на экране с приветствием.\n");
			printf("Введите имя: ");
			scanf("%s", first);
			printf("a. %s\n", first);
		...
		else if (nz == 2)
		{
			...
			system("cls");
			char footbol[Size];
			printf("2. Составить программу, которая запрашивает название футбольной\nкоманды и повторяет его на экране со словами \"— это чемпион!\"\n");
		...
		else if (nz == 4)
		{
			...
			system("cls");
			printf("4. Составить программу, которая запрашивает название государства и его столицы, а затем выводит сообщение:\n\"Столица государства ... — город ...\" (на месте многоточий должны быть выведены соответствующие значения)\n");
			char Stolica[Size];
			char City[Size];
			printf("Введите название столицы и города через пробел: ");
		...
		else if (nz == 5)
		{
			...
			system("cls");
			char footbol[Size];
			printf("5. Дано название футбольного клуба. Определить количество символов в нем\n");
		...
		else if (nz == 6)
		{
			...
			system("cls");
			char city[Size];
			printf("6. Дано название города. Определить, четно или нет количество символов в нем\n");
